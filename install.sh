...
printf "${RED}                __    ___  ___    ___  _____  ${WW}  _____    __  __  _____  _      __    __  __ " \n
printf "${RED}  /\  /\/\ /\  /__\  /___\/ __\  /___\/__   \ ${WW}  \_   \/\ \ \/ _\/__   \/_\    / /   /__\/__\" \n
printf "${RED} / /_/ / / \ \/ \// //  //__\// //  //  / /\/ ${WW}   / /\/  \/ /\ \   / /\//_\\  / /   /_\ / \//" \n
printf "${RED}/ __  /\ \_/ / _  \/ \_// \/  \/ \_//  / /    ${WW}/\/ /_/ /\  / _\ \ / / /  _  \/ /___//__/ _  \" \n
printf "${RED}\/ /_/  \___/\/ \_/\___/\_____/\___/   \/     ${WW}\____/\_\ \/  \__/ \/  \_/ \_/\____/\__/\/ \_/" \n                                                                               
...
printf "\nТелеграмм канал:${WW}@hurodev${RED}/n" 
printf "${RZ}--------------------------------------------------${NC}\n"
printf "ㅤㅤㅤ${RED}Установка завершена!${NC}"
printf "ㅤㅤㅤДля запуска: ${RED}hurobot${NC}"
